...
public class PPSwerveControllerCommand extends CommandBase {
    ...
    private static Consumer<PathPlannerState> logTargetState = null;
    ...
    public void execute() {
        ...
        if (logTargetState != null) {
            logTargetState.accept(desiredState);
        }
    ...
    public static void setLoggingCallbacks(
            ...
            Consumer<PathPlannerState> logTargetState,
        ...
        PPSwerveControllerCommand.logTargetState = logTargetState;
